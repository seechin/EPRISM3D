...
EPISol can use the XTC libaries of GROMACS to read XTC trajectories. In order to do this, please setup the GROMACS environments (e.g. source GMXRC files) in the terminal before you start the EPISol server. For example, suppose you have a GROMACS 2018 installed in /opt/gromacs-2018.1:
